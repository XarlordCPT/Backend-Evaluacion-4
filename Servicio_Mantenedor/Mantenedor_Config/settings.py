...
ROOT_URLCONF = 'Mantenedor_Config.urls'
...
WSGI_APPLICATION = 'Mantenedor_Config.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Servicio Mantenedor',
    'DESCRIPTION': 'Documentación de la API del Servicio Mantenedor',
    'VERSION': '1.0.0',
